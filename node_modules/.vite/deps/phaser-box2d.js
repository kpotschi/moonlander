...
// node_modules/phaser-box2d/dist/PhaserBox2D-Debug.js
...
var b2Island = class {
  constructor() {
    __publicField(this, "setIndex", 0);
    __publicField(this, "localIndex", 0);
    __publicField(this, "islandId", 0);
    __publicField(this, "headBody", 0);
    __publicField(this, "tailBody", 0);
    __publicField(this, "bodyCount", 0);
    __publicField(this, "headContact", 0);
    __publicField(this, "tailContact", 0);
    __publicField(this, "contactCount", 0);
    __publicField(this, "headJoint", 0);
    __publicField(this, "tailJoint", 0);
    __publicField(this, "jointCount", 0);
    __publicField(this, "parentIsland", 0);
    __publicField(this, "constraintRemoveCount", 0);
  }
};
...
var b2World = class {
  constructor() {
    __publicField(this, "stackAllocator", new b2StackAllocator());
    __publicField(this, "broadPhase", new b2BroadPhase());
    __publicField(this, "constraintGraph", new b2ConstraintGraph());
    // bodyIdPool = new b2IdPool();
    __publicField(this, "bodyArray", []);
    // solverSetIdPool = new b2IdPool();
    __publicField(this, "solverSetArray", []);
    // jointIdPool = new b2IdPool();
    __publicField(this, "jointArray", []);
    // contactIdPool = new b2IdPool();
    __publicField(this, "contactArray", []);
    // islandIdPool = new b2IdPool();
    __publicField(this, "islandArray", []);
    // shapeIdPool = new b2IdPool();
    // chainIdPool = new b2IdPool();
    __publicField(this, "shapeArray", []);
    __publicField(this, "chainArray", []);
    __publicField(this, "taskContextArray", []);
    __publicField(this, "bodyMoveEventArray", []);
    __publicField(this, "sensorBeginEventArray", []);
    __publicField(this, "sensorEndEventArray", []);
    __publicField(this, "contactBeginArray", []);
    __publicField(this, "contactEndArray", []);
    __publicField(this, "contactHitArray", []);
    __publicField(this, "debugBodySet", new b2BitSet());
    __publicField(this, "debugJointSet", new b2BitSet());
    __publicField(this, "debugContactSet", new b2BitSet());
    __publicField(this, "stepIndex", 0);
    __publicField(this, "splitIslandId", 0);
    __publicField(this, "gravity", new b2Vec2(0, 0));
    __publicField(this, "hitEventThreshold", 0);
    __publicField(this, "restitutionThreshold", 0);
    __publicField(this, "maxLinearVelocity", 0);
    __publicField(this, "contactPushoutVelocity", 0);
    __publicField(this, "contactHertz", 0);
    __publicField(this, "contactDampingRatio", 0);
    __publicField(this, "jointHertz", 0);
    __publicField(this, "jointDampingRatio", 0);
    __publicField(this, "revision", 0);
    // profile = new b2Profile();
    __publicField(this, "preSolveFcn", null);
    __publicField(this, "preSolveContext", null);
    __publicField(this, "customFilterFcn", null);
    __publicField(this, "customFilterContext", null);
    __publicField(this, "workerCount", 0);
    __publicField(this, "userTaskContext", null);
    __publicField(this, "userTreeTask", null);
    __publicField(this, "inv_h", 0);
    __publicField(this, "worldId", new b2WorldId());
    __publicField(this, "enableSleep", true);
    __publicField(this, "locked", false);
    __publicField(this, "enableWarmStarting", false);
    __publicField(this, "enableContinuous", false);
...
function SpriteToBox(worldId, sprite, data) {
  var _a2, _b;
  const scaleX = (sprite == null ? void 0 : sprite.scaleX) || ((_a2 = sprite == null ? void 0 : sprite.scale) == null ? void 0 : _a2.x) || 1;
  const scaleY = (sprite == null ? void 0 : sprite.scaleY) || ((_b = sprite == null ? void 0 : sprite.scale) == null ? void 0 : _b.y) || 1;
  const props = {
    worldId,
    type: DYNAMIC,
...
var _a;
var Skeletons = (_a = class {
}, __publicField(_a, "HumanBones", {
  e_hip: 0,
  e_torso: 1,
  e_head: 2,
  e_upperLeftLeg: 3,
  ...
  e_lowerRightArm: 10,
  e_count: 11
}), __publicField(_a, "sideViewHuman11", {
  BONE_DATA: [
...
}), __publicField(_a, "frontViewHuman11", {
  BONE_DATA: [
...
}), __publicField(_a, "ElephantBones", {
  e_torso: 0,
  e_head: 1,
  e_trunkBase: 2,
  e_trunkMid: 3,
  ...
  e_ear: 10,
  e_count: 11
}), __publicField(_a, "sideViewElephant", {
  BONE_DATA: [
...
phaser-box2d/dist/PhaserBox2D-Debug.js:
  (**
   * @license
   * Phaser Box2D v1.1.0
   ...
   *)
*/
//# sourceMappingURL=phaser-box2d.js.map
